...
A week ago, I started reading "Wizards Who Stay Up Late" (1996). The author emphasizes at several points that a lot of the BBN technologists were in the top 1% of the top 1% of their class, or amongst hackers, the most brilliant at fixing the rarest bugs, like a synchronization bug (Crowther). This board may not be as complicated as a sync timer, but it is remarkable how much knowledge is required to build it, and yet seemingly few actually did a thorough benchnark of all it's features/capabilities. It would be nice if I can scrape the surface of any of its functionality, and extraordinary if I didn't encounter a single bug.
